                    ...
                    <div className='flex-1 p-[18px] pl-[19px] w-full bg-white overflow-y-scroll'>
                        ...
                        <div className="flex flex-col gap-[16px] mt-[6px] text-rtc_navy">
                            <div className="flex items-start gap-[8px]">
                                ...
                                <div className={`w-[120px] font-regular text-label ${selectedDistrictFeatures?.properties.Party_x === "Democratic" ? "text-demo_1" : "text-rep_1"}`}><span className='font-bold'>{selectedDistrictFeatures?.properties!.NAME}</span><br /> {selectedDistrictFeatures?.properties!.Party_y}</div>
                            </div>
                            {
